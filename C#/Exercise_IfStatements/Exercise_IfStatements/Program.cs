...
{
    Console.WriteLine("walked straight");
}
else if (input1=="c")
{
...
else if ((leftLeverState == "up" & centerLeverState == "down" & rightLeverState == "down")|(leftLeverState == "down" & centerLeverState == "down" & rightLeverState == "up"))
{
